        ...
        {thisRoutine ?
            <div className='routine_item'> 
                ...
                <div>
                    ...
                    <ol>
                        {thisRoutine && thisRoutine.activities && thisRoutine.activities.length ? thisRoutine.activities.map((elem) => {
                        return <ActivityItem key={"activity_" + elem.id} activity={elem} isOwner={isOwner} list={list} setList={setList} />
                        }) : null}
                    </ol>
                ...
                : null}
                {readyToEdit ? <EditRoutineForm routine={thisRoutine} setRoutine={setThisRoutine} setReady={setReadyToEdit}/> : null}
                {readyToAddActivity ? <AddActivityForm routine={thisRoutine} setRoutine={setThisRoutine} setReady={setReadyToAddActivity}/> : null}
            </div>
        : null}
        </>
    )
